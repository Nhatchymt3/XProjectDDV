...
namespace XProject.Repository.Migrations
{
    ...
    [Migration("20220509071124_init5")]
    partial class init5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XProject.Contract.Repository.Models.TD_CUSTOMER_INFO", b =>
                {
                    ...
                    b.HasIndex("File_Sharing_ID")
                        .IsUnique()
                        .HasFilter("[File_Sharing_ID] IS NOT NULL");
            ...
            modelBuilder.Entity("XProject.Contract.Repository.Models.TD_SHARING_INFO", b =>
                {
                    ...
                    b.Property<string>("TM_DD_MEMBERsId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("XProject.Contract.Repository.Models.TD_CUSTOMER_INFO", b =>
                {
                    b.HasOne("XProject.Contract.Repository.Models.TD_SHARING_INFO", "TD_SHARING_INFO")
                        .WithOne("TD_CUSTOMER_INFO")
                        .HasForeignKey("XProject.Contract.Repository.Models.TD_CUSTOMER_INFO", "File_Sharing_ID");
            ...
            modelBuilder.Entity("XProject.Contract.Repository.Models.TD_SHARING_INFO", b =>
                {
                    b.HasOne("XProject.Contract.Repository.Models.TM_DD_MEMBER", "TM_DD_MEMBERs")
                        .WithMany("TD_SHARING_INFO")
                        .HasForeignKey("TM_DD_MEMBERsId");
